...
export interface Projects_codeBase {
  ID?: number;
  Title?: string;
  description?: string;
  start_date?: string;
...
export interface Projects_codeRead extends Projects_codeBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}

export interface Projects_codeWrite extends Projects_codeBase {
  Author?: AuthorValue;
  Editor?: EditorValue;
}
