  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-6 mb-20 bg-white rounded shadow w-full">
      ...
      <p className="text-gray-700 text-lg">
        <strong>Time Tracker</strong> — веб-приложение для учета рабочего
        времени сотрудников с интерактивной таблицей проектов и задач.
      </p>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-1 text-gray-700">
          ...
          <li>
            Уведомления через Toast (<code>react-toastify</code>)
          </li>
        </ul>
      </section>
            ...
            <tbody className="divide-y divide-gray-200 text-gray-700">
              ...
              <tr>
                <td className="px-4 py-2">
                  src/pages/TimeSheetPage/TimeSheetPage.tsx
                </td>
                <td className="px-4 py-2">
                  Страница таймшита, оборачивает таблицу
                </td>
              </tr>
              <tr>
